...
vector<NNEvaluator*> Setup::initializeNNEvaluators(
  ...
  for(size_t i = 0; i<nnModelFiles.size(); i++) {
    ...
    //MIGraphX takes NCHW inputs: migraphxTransformerNHWC defaults false, see migraphxbackend.cpp.
    bool inputsUseNHWC = backendPrefix == "opencl" || backendPrefix == "trt" || backendPrefix == "migraphx" || backendPrefix == "metal" || backendPrefix == "onnx" ? false : true;
